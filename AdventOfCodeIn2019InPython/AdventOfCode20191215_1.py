...
def main():
    ...
    shortest_path = _shortest_path_to_target(repair_droid)
    print([int(direction) for direction in shortest_path])
...
def _shortest_path_to_target(repair_droid : RepairDroid) -> Optional[List[Direction]]:
    ...
    visited_locations : Dict[Point,Path]= {(0,0) : []}
    path_queue = queue.Queue()
    path_queue.put_nowait((0,0))
