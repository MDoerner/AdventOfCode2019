...
class Network:
    ...
    def execute_network(self):
        while not self._out_of_network_message_encountered:
...
def main():
    ...
    network_nodes = [NetworkNode(processor, code.copy(), address) for address in network_addresses]
    network = Network(network_nodes)
