module AdventOfCode20191207_1
    (
        linearAmplifierOptimization,
        bestLinearAmplifierSettings
    ) where
...
linearAmplifierOptimization :: IO ()
linearAmplifierOptimization = do
    inputText <- readFile "Advent20191207_1_input.txt"
    let code = toIntCode inputText
    let bestBoost = highestBoost sum [0] code [0..4]
    print bestBoost

bestLinearAmplifierSettings :: IO ()
bestLinearAmplifierSettings = do
    inputText <- readFile "Advent20191207_1_input.txt"
    let code = toIntCode inputText
    let bestSettings = bestPhaseSetting sum [0] code [0..4]
    print bestSettings
...
executeAmplifier input code phaseSettings = executeProcessArrayOnce input (amplifierConfiguration code phaseSettings)
